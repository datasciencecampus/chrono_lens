...
class TestNewcastleDetector(TestCase):
    ...
    def setUpClass(cls):
        ...
        sample_image_path = os.path.join('..', 'dsc_lib_tests', 'test_data', 'test_detector_data',
        ...
        raw_large_sample_image_bgr = cv2.imread(os.path.join('..', 'dsc_lib_tests', 'test_data', 'time_series',
        ...
        with open(os.path.join('..', 'dsc_lib_tests', 'test_data', 'test_detector_data',
